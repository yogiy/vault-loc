<section class="content">
    <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    <div style="text-align:right">
                        ...
                        <a href="<?php echo base_url();?>admin/settings/client/add" class="btn btn-blue" >Add new</a> &nbsp;
                    </div>
                </div>
            </div>
        </div>
        <ol class="breadcrumb bc-3">
            ...
            <li class="active"><strong>Client List</strong></li>
        </ol>
        <div class="row clearfix">
                                        ...
                                        <table class="table table-bordered table-hover dataTable table-striped"  id="table-2"  data-page-length="50">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $results[$i]['fname'];?> <?php echo $results[$i]['lname'];?></td>
														<td><?php echo $results[$i]['email'];?></td>
														<td><?php echo $results[$i]['phone'];?></td>
														<td><?php echo date('d-m-Y', strtotime($results[$i]['created_at']));?></td>
                                                        <td style="text-align:center;">
                                                            <?php if($results[$i]['status']=='Active'){ ?>
                                                                <a href="<?php echo base_url();?>admin/settings/client/<?php echo $results[$i]['user_id'];?>/Deactive" title="Click for Deactive" onclick="return action('deactive');">
                                                                    <i class="fa fa-toggle-on" aria-hidden="true" style="color:green; font-size:18px;"></i>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="<?php echo base_url();?>admin/settings/client/<?php echo $results[$i]['user_id'];?>/Active" title="Click for Active" onclick="return action('active');">
                                                        ...
                                                        <td style="text-align:center;border-right: 1px solid #ebebeb !important;">
                                                            <a  href="<?php echo base_url();?>admin/settings/client/edit/<?php echo $results[$i]['user_id'];?>" class="actionP">
