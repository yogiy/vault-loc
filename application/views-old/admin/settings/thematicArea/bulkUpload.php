    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row clearfix">
                <div class="col-sm-6">
                    <h2>Thematic Areas (Excel Import)</h2>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-default" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        <div class="clearfix">
                            <?php echo form_open_multipart(base_url().'admin/bulkUploadThematicAreaStore',array('method'=>'post', 'name'=>'add_common','id'=>'add_common','class'=>'form-horizontal form-groups-bordered','autocomplete'=>'off'));?>
                            <div class="col-md-12">
