<section class="content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li><a href="<?php echo base_url();?>admin/settings/ngo/display">NGO</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-default" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        <div class="clearfix">
                            <?php echo form_open_multipart(base_url().'admin/bulkUploadNGOStore',array('method'=>'post', 'name'=>'add_common','id'=>'add_common','class'=>'form-horizontal form-groups-bordered','autocomplete'=>'off'));?>
                            <div class="col-md-12">
