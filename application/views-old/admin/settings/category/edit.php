...
<section class="content">
	<div class="container-fluid">
        ...
        <ol class="breadcrumb bc-3">
			...
			<li><a href="<?php echo base_url();?>admin/settings/categories/display">Categories</a></li>
			<li class="active"><strong>Update Categories</strong></li>
        </ol>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="body">
						<?php echo form_open_multipart(base_url().'admin/settings/category/update',array('method'=>'post', 'name'=>'add_common','id'=>'add_common','class'=>'form-horizontal form-groups-bordered','autocomplete'=>'off'));?>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="button-demo">
											...
											<a href="<?php echo base_url();?>admin/settings/categories/display" class="btn btn-md bg-orange waves-effect">Cancel</a>
										</div>
									</div>
								</div>
							</div>
