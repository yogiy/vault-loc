            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    <div style="text-align:right">
                        ...
                        <a href="<?php echo base_url();?>admin/settings/category/add" class="btn btn-blue" >Add new</a> &nbsp;
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <?php if($results[$i]['status']=='Active'){ ?>
                                                                <a href="<?php echo base_url();?>admin/settings/category/<?php echo $results[$i]['category_id'];?>/Deactive" title="Click for Deactive" onclick="return action('deactive');">
                                                                    <i class="fa fa-toggle-on" aria-hidden="true" style="color:green; font-size:18px;"></i>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="<?php echo base_url();?>admin/settings/category/<?php echo $results[$i]['category_id'];?>/Active" title="Click for Active" onclick="return action('active');">
                                                        ...
                                                        <td style="text-align:center;border-right: 1px solid #ebebeb !important;">
                                                            <a  href="<?php echo base_url();?>admin/settings/category/edit/<?php echo $results[$i]['category_id'];?>" class="actionP">
