            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    <div style="text-align:right">
                        <a href="<?php echo base_url();?>settings/users/display" class="btn bg-orange">Back</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open_multipart(base_url().'admin/settings/user/update',array('method'=>'post', 'name'=>'add_user','id'=>'add_user','class'=>'form-horizontal form-groups-bordered','autocomplete'=>'off'));?>
