<section class="content">
    <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    <div style="text-align:right">
                        ...
                        <a href="<?php echo base_url();?>admin/settings/team/add" class="btn btn-blue" >Add new</a> &nbsp;
                    </div>
                </div>
            </div>
        </div>
        <ol class="breadcrumb bc-3">
            ...
            <li class="active"><strong>Team List</strong></li>
        </ol>
        <div class="row clearfix">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <?php if($results[$i]['status']=='Active'){ ?>
                                                                <a href="<?php echo base_url();?>admin/settings/team/<?php echo $results[$i]['team_id'];?>/Deactive" title="Click for Deactive" onclick="return action('deactive');">
                                                                    <i class="fa fa-toggle-on" aria-hidden="true" style="color:green; font-size:18px;"></i>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="<?php echo base_url();?>admin/settings/team/<?php echo $results[$i]['team_id'];?>/Active" title="Click for Active" onclick="return action('active');">
                                                        ...
                                                        <td style="text-align:center;border-right: 1px solid #ebebeb !important;">
                                                            <a  href="<?php echo base_url();?>admin/settings/team/edit/<?php echo $results[$i]['team_id'];?>" class="actionP">
