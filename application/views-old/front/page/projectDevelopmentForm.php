                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control"  name="status">
                                    ...
                                    <option <?php if(!empty($ideations[0]) && $ideations[0]['b_status'] =='WIP') echo "selected"?>>Did not win</option>
                                    <option <?php if(!empty($ideations[0]) && $ideations[0]['b_status'] =='Pending') echo "selected"?>>Pending </option>
									<option <?php if(!empty($ideations[0]) && $ideations[0]['b_status'] =='Completed') echo "selected"?>>Win</option>
                                </select>
                            </div>
                            <div class="col-sm-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control" name="feedback_b_status">
                                    <option value="">Please Select</option>
                                    <option <?php if(!empty($feedback[0]) && $feedback[0]['b_status'] =='WIP') echo "selected"?>>Did not win</option>
									<option <?php if(!empty($feedback[0]) && $feedback[0]['b_status'] =='Pending') echo "selected"?>>Pending </option>
                                    <option <?php if(!empty($feedback[0]) && $feedback[0]['b_status'] =='Completed') echo "selected"?>>Win</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control"  name="rework_b_status">
                                    <option value="">Please Select</option>
									<option <?php if(!empty($rework) && !empty($rework[0]['b_status'])  && $rework[0]['b_status'] =='WIP'){ echo 'selected';}?>>Did not win</option>
                                    <option <?php if(!empty($rework) && !empty($rework[0]['b_status'])  && $rework[0]['b_status'] =='Pending '){  echo 'selected';}?>>Pending </option>
                                    <option <?php if(!empty($rework[0]['b_status'] ) && $rework[0]['b_status'] =='Completed'){ echo 'selected';}?>>Win</option>
                                </select>
                            </div>
                            <div class="col-sm-1">
                                <?php if(empty($ideations)){
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control"  name="mou_b_status">
                                            <option value="">Please Select</option>
                                            <option value="Pending" <?php if(!empty($mou) && !empty($mou[0]['b_status'])  && $mou[0]['b_status'] =='Pending'){  echo 'selected';}?>>Pending </option>
