					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<select name="theme_id" id="theme_id" class="form-control">
								...
								?>
									<option value="<?php echo $theme['thematic_area_id'];?>" <?php if($theme['thematic_area_id'] == $data['theme_id']){ echo "selected=selected";}?>><?php echo $theme['title'];?> - [<?php echo $thematicArea[0]['title'];?>]</option>
								<?php }?>
							</select>
						</div>
					</div>
