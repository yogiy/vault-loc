        ...
        <div class="row">
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    <input type="date"  class="form-control search" name="receipt_date" value="<?php if(!empty($mou[0]['receipt_date'])) echo date($mou[0]['receipt_date'])?>"  placeholder="yyyy/mm/dd"/>
                </div>
                <div class="form-group">
                    <label>Budget Allocated</label>
                    <input type="number" min="0" name="budget" value="<?php if(!empty($mou[0]['budget'])) echo date($mou[0]['budget'])?>" class="form-control search"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control search" id="fund_disbursement" name="fund_disbursement">
                ...
                <div class="form-group custom-div" <?php if(!empty($mou[0]['fund_disbursement']) && $mou[0]['fund_disbursement']== 'Custom') echo '';else echo 'style="display: none"';?>>
                    <input type="date" class="form-control search" value="<?php if(!empty($mou[0]['fund_start_date'])) echo date($mou[0]['fund_start_date'])?>" name="fund_start_date" min="2000-01-01"  placeholder="yyyy/mm/dd"/>
                </div>
                <div class="form-group custom-div" <?php if(!empty($mou[0]['fund_disbursement']) && $mou[0]['fund_disbursement']== 'Custom') echo '';else echo 'style="display: none"';?>>
                    <input type="date" class="form-control search" value="<?php if(!empty($mou[0]['fund_end_date'])) echo date($mou[0]['fund_end_date'])?>" name="fund_end_date" min="2000-01-01"  placeholder="yyyy/mm/dd"/>
                </div>
                <div class="form-group">
                    <label>Reporting Schedule</label>
                    <select class="form-control search" id="reporting_schedule" name="reporting_schedule">
                        <option value="">Please Select</option>
                ...
                <div class="form-group custom-div2" <?php if(!empty($mou[0]['reporting_schedule']) && $mou[0]['reporting_schedule']== 'Custom') echo '';else echo 'style="display: none"';?>>
                    <input type="date" class="form-control search" value="<?php if(!empty($mou[0]['report_start_date'])) echo date($mou[0]['report_start_date'])?>" name="report_start_date"  min="2000-01-01" placeholder="yyyy/mm/dd"/>
                </div>
                <div class="form-group custom-div2" <?php if(!empty($mou[0]['reporting_schedule']) && $mou[0]['reporting_schedule']== 'Custom') echo '';else echo 'style="display: none"';?>>
                    <input type="date" class="form-control search" value="<?php if(!empty($mou[0]['report_end_date'])) echo date($mou[0]['report_end_date'])?>" name="report_end_date" min="2000-01-01"  placeholder="yyyy/mm/dd"/>
                </div>
            </div>
            <div class="col-sm-10">
                <div class="row min-h">
                    <div class="col-sm-1">
                     <?php if(!empty($baseline_study[0]['b_status'] ) && $baseline_study[0]['b_status'] =='Completed'){echo '<div class="circle"></div> ';}else{echo '<div class="grey-circle"></div> ';}   ?>
                    </div>
                    <div class="col-sm-11">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="upload-btn-wrapper  form-group">
                                            ...
                                            <input  class=" form-control search col-sm-12 file1"   type="file" name="baseline_study" id="baseline_study"  />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 row">
                                        <div class="input-group">
                                            <input type="text" name="base_mail_id" value="<?php if(!empty($baseline_study[0]['mail_id'])){  echo $baseline_study[0]['mail_id'];} else{ echo $client[0]['email']; }?>" class="form-control search" placeholder="Send to client Email ID">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 form-group">
                                <select class="form-control search"   name="base_b_status">
                                    <option value="">Please Select</option>
                ...
                <div class="row min-h">
                    <div class="col-sm-1">
                        <?php if(!empty($need_assessment[0]['b_status'] ) && $need_assessment[0]['b_status'] =='Completed'){echo '<div class="circle"></div> ';}else{echo '<div class="grey-circle"></div> ';}   ?>
                    </div>
                    <div class="col-sm-11">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 row">
                                        <div class="input-group">
                                            <input type="text" class="form-control search"  value="<?php if(!empty($need_assessment[0]['mail_id'])){  echo $need_assessment[0]['mail_id'];} else{ echo $client[0]['email']; }?>" name="need_mail_id" placeholder="Send to client Email ID">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <select class="form-control search"  name="need_b_status">
                                    <option value="">Please Select</option>
                ...
                <div class="row min-h">
                    <div class="col-sm-1">
                        <?php
                        if(!empty($monitoring[0]['pre_preparation_b_status'] ) && $monitoring[0]['pre_preparation_b_status'] =='Completed'
                            && !empty($monitoring[0]['iInterim_b_status'] ) && $monitoring[0]['iInterim_b_status'] =='Completed'
                        && !empty($monitoring[0]['final_b_status'] ) && $monitoring[0]['final_b_status'] =='Completed')
                        {echo '<div class="circle"></div> ';}else{echo '<div class="grey-circle"></div> ';}
                        ?>
                    </div>
                    <div class="col-sm-11">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date" name="pre_preparation_follow_up_date" value="<?php if(!empty($monitoring[0]['pre_preparation_follow_up_date'])){  echo date($monitoring[0]['pre_preparation_follow_up_date']);}?>" class="form-control search"    min="2000-01-01"   placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="upload-btn-wrapper">
                                            <button class="btn">Choose file</button>
                                            <input  class="col-sm-12 form-control search file3"  type="file" name="pre_preparation_excel" id="pre_preparation_excel"  />
                            ...
                            <div class="col-sm-3">
                                <select class="form-control search"   name="pre_preparation_b_status">
                                    <option value="">Please Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date" value="<?php if(!empty($monitoring[0]['iInterim_follow_up_date'])){  echo date($monitoring[0]['iInterim_follow_up_date']);}?>" name="iInterim_follow_up_date" class="form-control search" min="2000-01-01" placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control search"   name="iInterim_b_status">
                                    <option value="">Please Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date" value="<?php if(!empty($monitoring[0]['final_follow_up_date'])){  echo date($monitoring[0]['final_follow_up_date']);}?>" name="final_follow_up_date" class="form-control search"  min="2000-01-01" placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control search"   name="final_b_status">
                                    <option value="">Please Select</option>
                ...
                <div class="row min-h">
                    <div class="col-sm-1">
                        <?php
                        if(!empty($reporting[0]['pre_preparation_b_status'] ) && $reporting[0]['pre_preparation_b_status'] =='Completed'
                            && !empty($reporting[0]['iInterim_b_status'] ) && $reporting[0]['iInterim_b_status'] =='Completed'
                            && !empty($reporting[0]['final_b_status'] ) && $reporting[0]['final_b_status'] =='Completed')
                        {echo '<div class="circle"></div> ';}else{echo '<div class="grey-circle"></div> ';}
                        ?>    </div>
                    <div class="col-sm-11">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date"  name="report_pre_preparation_follow_up_date" value="<?php if(!empty($reporting[0]['pre_preparation_follow_up_date'])){  echo date($reporting[0]['pre_preparation_follow_up_date']);}?>" class="form-control search"  min="2000-01-01"  placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control search"  name="report_pre_preparation_b_status">
                                    <option value="">Please Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date" name="report_iInterim_follow_up_date"  value="<?php if(!empty($reporting[0]['iInterim_follow_up_date'])){  echo date($reporting[0]['iInterim_follow_up_date']);}?>" class="form-control search" min="2000-01-01"  placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control search"  name="report_iInterim_b_status">
                                    <option value="">Please Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date" name="report_final_follow_up_date" value="<?php if(!empty($reporting[0]['final_follow_up_date'])){  echo date($reporting[0]['final_follow_up_date']);}?>" class="form-control search" min="2000-01-01" placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control search"  name="report_final_b_status">
                                    <option value="">Please Select</option>
                ...
                <div class="row">
                    <div class="col-sm-offset-1 col-sm-11">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <input type="date" name="set_reminder"  value="<?php if(!empty($management[0]['set_reminder'])){  echo date($management[0]['set_reminder']);}?>" min="2000-01-01" class="form-control search text-box-orange" placeholder="yyyy/mm/dd"/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                       ...
                                       <div> <a href="<?php echo base_url();?>uploads/excelSample/benificary_impact.csv" download=""><small><i class="fa fa-download"></i>View Sample File</small></a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div> <a href="<?php echo base_url();?>uploads/excelSample/project_assessment.csv" download=""><small><i class="fa fa-download"></i>View Sample File</small></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
