...
$selectedState = $this->session->userdata('state_id');?>
							...
							<select name="theme_id" id="theme_id" class="form-control">
								...
								<?php 
									foreach($themes as $theme) 
									{
									    //print_r($theme);
								?>
									<option value="<?php echo $theme['sector_id'];?>" <?php if($this->session->userdata('theme_id')==$theme['sector_id']){ echo "selected=selected";}?>><?php echo $theme['title'];?> </option>
								<?php } //die;?>
							</select>
						</div>
					</div>
