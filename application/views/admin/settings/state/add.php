<section class="content">
	<div class="container-fluid">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li class="active"><strong>Add States</strong></li>
        </ol>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="body">
						<?php echo form_open_multipart(base_url().'admin/settings/state/insert',array('method'=>'post', 'name'=>'add_common','id'=>'add_common','class'=>'form-horizontal form-groups-bordered','autocomplete'=>'off'));?>
