            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    <div style="text-align:right">
                        ...
                        <a href="<?php echo base_url();?>admin/settings/state/district" class="btn btn-blue" >Add District</a> &nbsp;
                        <a href="<?php echo base_url();?>admin/settings/state/add" class="btn btn-blue" >Add new</a> &nbsp;
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <table class="table table-bordered table-hover dataTable table-striped"  id="table-2"  data-page-length="50">
                                            ...
                                            <?php
												if($count > 0) 
												{
													...
													{
														$j++;
														$country =$this->Crud_model->getData('countries','id',1);
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <?php if($results[$i]['status']=='Active'){ ?>
                                                                <a href="<?php echo base_url();?>admin/settings/state/<?php echo $results[$i]['state_id'];?>/Deactive" title="Click for Deactive" onclick="return action('deactive');">
                                                                    <i class="fa fa-toggle-on" aria-hidden="true" style="color:green; font-size:18px;"></i>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="<?php echo base_url();?>admin/settings/state/<?php echo $results[$i]['state_id'];?>/Active" title="Click for Active" onclick="return action('active');">
                                                        ...
                                                        <td style="text-align:center;border-right: 1px solid #ebebeb !important;">
                                                            <a  href="<?php echo base_url();?>admin/settings/state/edit/<?php echo $results[$i]['state_id'];?>" class="actionP">
