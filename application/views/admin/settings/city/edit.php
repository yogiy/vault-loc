...
<section class="content">
	<div class="container-fluid">
        ...
        <ol class="breadcrumb bc-3">
			...
			<li><a href="<?php echo base_url();?>admin/settings/cities/display">Cities</a></li>
			<li class="active"><strong>Update city</strong></li>
        </ol>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="body">
						<?php echo form_open_multipart(base_url().'admin/settings/city/update',array('method'=>'post', 'name'=>'add_common','id'=>'add_common','class'=>'form-horizontal form-groups-bordered','autocomplete'=>'off'));?>
                                                ...
                                                <div class="form-line col-md-12">
                                                    <select class="form-control" name="state_id" id="state_id">
                                                        ...
                                                        <?php foreach ($states as $state) {?>
                                                            <option value="<?php echo $state['state_id']?>" <?php if($state['state_id'] == $data['state_id']) echo"selected";?>><?php echo $state['title']?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
